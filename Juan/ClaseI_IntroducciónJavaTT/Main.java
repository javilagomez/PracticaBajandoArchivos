...
public class Main {
    ...
    // PASO 3
    public static List<List<String>> hacerCubeta(){
    ...
    // PASO 4
    public static String[] reorganiza(String[] sArrCeros){
        int conteo = 0, bandera = 0;
        char indice[] = new char[sArrCeros.length];

        while (conteo < 3){
            List<List<String>> cubeta = hacerCubeta();
            ...
            //List<String> ListaAux = reorganiza(sArrCeros, indice, cubeta);
